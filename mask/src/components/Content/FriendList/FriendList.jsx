...
let FriendList = (props) => {
    return (
        <div className='row'>
            <Pagination totalUsers={props.totalUsers} countUsers={props.countUsers} currentPage={props.currentPage} setCurrentPage={props.setCurrentPage} />
            <div className='col-md-12'>
                {props.users.map((user) => <FriendItem
                    name={user.name}
